...
export declare class AdminController {
    ...
    listDatasets(page?: string, pageSize?: string): Promise<{
        data: ({
            _count: {
                equations: number;
            };
    ...
    publishDataset(id: string, req: any): Promise<{
        status: import(".prisma/client").$Enums.DatasetStatus;
        id: string;
        createdAt: Date;
        updatedAt: Date;
    ...
    deprecateDataset(id: string, req: any): Promise<{
        status: import(".prisma/client").$Enums.DatasetStatus;
        id: string;
        createdAt: Date;
        updatedAt: Date;
    ...
    importXlsx(file: Express.Multer.File, nomeDataset: string, req: any): Promise<{
        datasetId: string;
        total: number;
        imported: number;
        errors: string[];
    }>;
    listAuditLog(page?: string, pageSize?: string): Promise<{
        data: {
            id: string;
            createdAt: Date;
            acao: string;
